...
const seedCandidates: JobCandidate[] = [
  {
    ...
    recruiterNotes: 'Very strong communication and portfolio.',
    panelFeedback: 'Positive panel feedback on code quality.',
  ...
  },
  {
    ...
    recruiterNotes: 'Partial alignment with mobile requirements.',
    panelFeedback: 'Excellent UX case presentation.',
  ...
  },
  {
    ...
    recruiterNotes: 'Resume received, initial screening pending.',
    panelFeedback: '',
