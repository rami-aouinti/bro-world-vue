import type { ApiListResponse, CrmTaskRequestItem } from '~~/server/types/api/crm-general'
...
export default defineEventHandler(async (event): Promise<ApiListResponse<CrmTaskRequestItem>> => {
  return fetchCrmGeneral<ApiListResponse<CrmTaskRequestItem>>(event, 'me/assigned-task-requests', {
