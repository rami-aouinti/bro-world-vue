    ...
    groups: [
      ...
      },
      {
        ...
        endpoints: [
          ...
          { id: '44a-patch', title: 'Patch task request status', method: 'PATCH', path: '/api/v1/crm/task-requests/{taskRequest}/status', defaultBody: { status: 'progress' } },
          ...
          { id: '44d', title: 'List task request GitHub branches', method: 'GET', path: '/api/v1/crm/task-requests/{taskRequest}/github/branches' },
          { id: '44e', title: 'Create task request GitHub branch', method: 'POST', path: '/api/v1/crm/task-requests/{taskRequest}/github/branches', defaultBody: { name: 'feature/task-request-2142-gateway-timeout', sourceBranch: 'develop', postCommentOnIssue: true } },
          { id: '44f', title: 'Delete task request GitHub branch', method: 'DELETE', path: '/api/v1/crm/task-requests/{taskRequest}/github/branches/{branchId}' },
          { id: '44g', title: 'List task request GitLab branches', method: 'GET', path: '/api/v1/crm/task-requests/{taskRequest}/gitlab/branches' },
          { id: '44h', title: 'Create task request GitLab branch', method: 'POST', path: '/api/v1/crm/task-requests/{taskRequest}/gitlab/branches', defaultBody: { name: 'feature/task-request-2142-gateway-timeout', sourceBranch: 'develop', postCommentOnIssue: true } },
          { id: '44i', title: 'Delete task request GitLab branch', method: 'DELETE', path: '/api/v1/crm/task-requests/{taskRequest}/gitlab/branches/{branchId}' },
          { id: '44j', title: 'Upload task request files', method: 'POST', path: '/api/v1/crm/task-requests/{taskRequest}/files' },
