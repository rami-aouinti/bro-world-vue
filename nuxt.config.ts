...
const nonSitemapRouteRules = {
  '/admin/**': { sitemap: false },
  '/dashboard/**': { sitemap: false },
  '/login': { sitemap: false },
  '/register': { sitemap: false },
  '/auth': { sitemap: false },
  '/settings': { sitemap: false },
  '/calendar': { sitemap: false },
  '/inbox/**': { sitemap: false },
  '/notification/**': { sitemap: false },
  '/profile/**': { sitemap: false },
  '/platform/*/new/**': { sitemap: false },
  '/resume/preview/**': { sitemap: false },
  '/resume/template-capture/**': { sitemap: false },
  '/world/**/admin/**': { sitemap: false },
  '/world/jobs/admin': { sitemap: false },
  '/world/shop/admin': { sitemap: false },
} as const
...
export default defineNuxtConfig({
  ...
  routeRules: {
    ...indexableRouteRules,
    ...nonSitemapRouteRules,
    '/quiz': { redirect: '/applications/quiz', sitemap: false },
  },
  app: {
    head: {
