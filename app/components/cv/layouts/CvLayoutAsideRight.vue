...
.cv-aside-panel{position:absolute;right:0;top:24px;width:var(--cv-aside-width,120px);height:var(--cv-aside-height,1200px);padding:8px 10px;display:flex;flex-direction:column;gap:8px}
