...
.cv-content{display:grid;grid-template-columns:var(--cv-aside-width,280px) 1fr;gap:24px;padding:24px;min-height:0}
.cv-aside-panel{height:var(--cv-aside-height,1100px);background:var(--cv-primary,#1d4ed8);border-radius:var(--cv-aside-radius,18px);padding:16px;color:#fff}
