...
.cv-aside-line{position:absolute;left:var(--cv-aside-width,120px);top:24px;width:6px;height:var(--cv-aside-height,1200px);background:var(--cv-primary,#1d4ed8);border-radius:999px}
