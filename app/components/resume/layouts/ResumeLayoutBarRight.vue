...
<template>
  <ResumeLayoutAsideLeft :resume="resume" :template="template" :header-band-height="headerBandHeight" bar-only reverse  @change-variant="(sectionKey, variant) => emit('change-variant', sectionKey, variant)" />
</template>
