...
<template>
  <ResumeLayoutAsideLeft :resume="resume" :template="template" :header-band-height="headerBandHeight" header-on-primary  @change-variant="(sectionKey, variant) => emit('change-variant', sectionKey, variant)" />
</template>
