...
const props = withDefaults(defineProps<{
  resume: any
  editable?: boolean
  variant?: 'text-level' | 'stars' | 'progress' | string
...
<template>
  <section :class="[`density-${layoutDensity}`]" :style="sectionStyle">
    ...
    <ul v-else-if="variant === 'stars'" class="bars">
