...
<template>
  <div class="classic-template cv-template-base text-dark">
    <aside class="classic-sidebar cv-sidebar-surface">
...
.classic-template { font-family: var(--cv-font-family, 'Inter', 'Segoe UI', Arial, sans-serif); font-style: var(--cv-font-style, normal); font-weight: var(--cv-font-weight, 400); display:grid; grid-template-columns:260px 1fr; min-height: calc(100vh - 80px); background: var(--cv-page); border-radius: var(--cv-radius, 14px); overflow:hidden; }
