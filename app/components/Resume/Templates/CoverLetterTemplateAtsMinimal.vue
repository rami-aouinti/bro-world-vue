...
.cover-letter-ats {
  ...
  gap: 12px;
  line-height: 1.55;
  border: var(--cl-divider-width) var(--cl-divider-style)
    color-mix(in srgb, var(--cl-soft) 70%, var(--cl-page));
}
.cover-letter-ats p:first-child {
  font-weight: 700;
  color: var(--cl-page);
}
.cover-letter-ats p:nth-child(2) {
  font-size: 0.92rem;
}
</style>
