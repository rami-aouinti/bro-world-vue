...
<template>
  <div>
    ...
    <v-card rounded="xl" class="pa-4 mb-4 postcard-gradient-card">
      <h2 class="text-h6 mb-4">{{ t('world.crm.nav.githubSync', 'GitLab Sync') }}</h2>
      <v-row>
        <v-col cols="12" md="6">
          <AppSelect
            v-model="projectId"
        ...
        <v-col cols="12" md="6" class="d-flex align-center flex-wrap ga-2">
          <v-btn color="primary" :loading="gitlabStore.pending" @click="loadDashboard">Load dashboard</v-btn>
          <v-btn color="secondary" :loading="gitlabStore.pending" @click="loadRepositories">Load repositories</v-btn>
          <v-btn color="info" :loading="gitlabStore.pending" @click="loadGitlabOverview">Load all endpoints</v-btn>
        </v-col>
      </v-row>
      <v-row class="mb-1">
        <v-col cols="12" class="d-flex flex-wrap ga-2">
          <v-btn size="small" variant="tonal" :loading="gitlabStore.pending" @click="loadIssues">Load issues</v-btn>
          <v-btn size="small" variant="tonal" :loading="gitlabStore.pending" @click="loadPullRequests">Load pull requests</v-btn>
          <v-btn size="small" variant="tonal" :loading="gitlabStore.pending" @click="loadBranches">Load branches</v-btn>
          <v-btn size="small" variant="tonal" :loading="gitlabStore.pending" @click="loadProjectBoards">Load projects</v-btn>
          <v-btn size="small" variant="tonal" :loading="gitlabStore.pending" @click="loadAccountRepositories">Load account repositories</v-btn>
          <v-btn size="small" color="info" :loading="gitlabStore.pending" @click="loadGitlabOverview">Load all endpoints</v-btn>
        </v-col>
      </v-row>
      <v-alert v-if="gitlabStore.error" type="error" variant="tonal" class="mb-3">{{ gitlabStore.error }}</v-alert>
      <v-alert
        v-if="actionFeedback"
      ...
      <v-row>
        ...
        <v-col cols="12" md="4">
          <v-card v-if="projectBoards.length" variant="tonal" class="pa-3">
            <h3 class="text-subtitle-1 mb-2">GitLab projects ({{ projectBoards.length }})</h3>
            <v-list class="bg-transparent">
              <v-list-item
    ...
    <v-card rounded="xl" class="pa-4 mb-4 postcard-gradient-card">
      ...
      <v-row>
        ...
        <v-col cols="12" md="6"><v-text-field v-model="bootstrapPayload.token" label="GitLab token" type="password" /></v-col>
      ...
      <v-btn color="primary" :loading="gitlabStore.pending" @click="runBootstrap">Run bootstrap</v-btn>
      <v-alert
    ...
    <v-card rounded="xl" class="pa-4 postcard-gradient-card">
      ...
      <v-row>
        ...
        <v-col cols="12" md="4" class="d-flex align-center"><v-btn color="primary" :loading="gitlabStore.pending" @click="loadSyncJob">Load status</v-btn></v-col>
      </v-row>
