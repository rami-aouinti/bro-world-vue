...
<template>
  <div>
    ...
    <v-container fluid>
      ...
      <v-text-field v-model="applicationSlugInput" label="t('world.crm.repositories.fields.applicationSlugOptional')" variant="outlined" density="comfortable" class="mb-4" />
