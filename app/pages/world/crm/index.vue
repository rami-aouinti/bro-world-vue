...
async function moveDeal(
  ...
  if (isTransitioning.value || (deal.stage === toStage && !overrides.outcome)) {
    return
  }
  ...
  try {
    const payload = {
      ...
      expectedCloseDate: overrides.expectedCloseDate ?? deal.expectedCloseDate,
          ...
          >
            ...
            <div class="d-flex flex-column ga-3">
              ...
              >
                ...
                <p class="text-body-2 mb-1">{{ formatCurrency(deal.amount) }} · {{ deal.probability }}%</p>
                <p class="text-caption text-medium-emphasis mb-3">Close estimé: {{ formatDate(deal.expectedCloseDate) }}</p>
