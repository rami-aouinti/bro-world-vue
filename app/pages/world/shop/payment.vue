...
const rows = [
  { id: 'SH-01', name: 'Payment workflow A', owner: 'Team Alpha', status: 'Active', priority: 'High' },
  { id: 'SH-02', name: 'Payment workflow B', owner: 'Team Beta', status: 'Review', priority: 'Medium' },
  { id: 'SH-03', name: 'Payment workflow C', owner: 'Team Gamma', status: 'Draft', priority: 'Low' },
]
</script>
...
<template>
  <div>
    <WorldModuleDrawers
      ...
      action-label="Create Payment item"
    />

    <v-container fluid class="pt-0">
      <WorldFeatureScaffold
        title="Shop - Payment"
        subtitle="Gestion opérationnelle de payment avec formulaires et tableau de suivi."
        form-title="Create Payment record"
        form-description="Renseigne les informations métier pour le module payment."
        :fields="[
