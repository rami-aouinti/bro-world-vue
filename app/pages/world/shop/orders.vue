...
const rows = [
  { id: 'SH-01', name: 'Orders workflow A', owner: 'Team Alpha', status: 'Active', priority: 'High' },
  { id: 'SH-02', name: 'Orders workflow B', owner: 'Team Beta', status: 'Review', priority: 'Medium' },
  { id: 'SH-03', name: 'Orders workflow C', owner: 'Team Gamma', status: 'Draft', priority: 'Low' },
]
</script>
...
<template>
  <div>
    <WorldModuleDrawers
      ...
      action-label="Create Orders item"
    />

    <v-container fluid class="pt-0">
      <WorldFeatureScaffold
        title="Shop - Orders"
        subtitle="Gestion opérationnelle de orders avec formulaires et tableau de suivi."
        form-title="Create Orders record"
        form-description="Renseigne les informations métier pour le module orders."
        :fields="[
