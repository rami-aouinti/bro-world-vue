...
const { data, pending, error, refresh } = await useAsyncData(
  ...
  () => $fetch<{ items: Record<string, unknown>[] }>('/api/world/learning/public/school/grades'),
)
...
<template>
  <div>
    <WorldModuleDrawers
      ...
      :module-description="'School grades catalogue and filters'"
    ...
    <v-container fluid>
      <v-card rounded="xl" class="pa-5">
        <div class="d-flex align-center justify-space-between mb-4">
          <div>
            <h1 class="text-h5">Grades</h1>
            <p class="text-medium-emphasis mb-0">Public school endpoint: /school/general/grades</p>
          </div>
