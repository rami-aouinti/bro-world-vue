...
const rows = [
  { id: 'LE-1', title: 'Paths item A', owner: 'Mentor Team', level: 'Beginner', status: 'Open' },
  { id: 'LE-2', title: 'Paths item B', owner: 'Academy Ops', level: 'Intermediate', status: 'Draft' },
  { id: 'LE-3', title: 'Paths item C', owner: 'Curriculum', level: 'Advanced', status: 'Live' },
]
</script>
...
<template>
  <div>
    <WorldModuleDrawers
      ...
      action-label="Create Paths"
    />

    <v-container fluid class="pt-0">
      <WorldFeatureScaffold
        title="Learning - Paths"
        subtitle="Pilotage de paths avec formulaires détaillés et état d’avancement."
        form-title="Create Paths"
