...
const rows = [
  { id: 'JB-1', title: 'Apply process A', owner: 'Talent Team', stage: 'Screening', status: 'Open' },
  { id: 'JB-2', title: 'Apply process B', owner: 'Hiring Manager', stage: 'Interview', status: 'Review' },
  { id: 'JB-3', title: 'Apply process C', owner: 'Recruiter', stage: 'Offer', status: 'Closed' },
]
</script>
...
<template>
  <div>
    <WorldModuleDrawers
      ...
      action-label="Create Apply"
    />

    <v-container fluid class="pt-0">
      <WorldFeatureScaffold
        title="Jobs - Apply"
        subtitle="Pilotage métier de Apply avec formulaires structurés et données tabulaires."
        form-title="Create Apply record"
