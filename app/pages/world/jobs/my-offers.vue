...
const rows = [
  { id: 'JB-1', title: 'My Offers process A', owner: 'Talent Team', stage: 'Screening', status: 'Open' },
  { id: 'JB-2', title: 'My Offers process B', owner: 'Hiring Manager', stage: 'Interview', status: 'Review' },
  { id: 'JB-3', title: 'My Offers process C', owner: 'Recruiter', stage: 'Offer', status: 'Closed' },
]
</script>
  ...
  <div>
    ...
    <v-container fluid class="pt-0">
      <WorldFeatureScaffold
        title="Jobs - My Offers"
        subtitle="Pilotage métier de My Offers avec formulaires structurés et données tabulaires."
        form-title="Create My Offers record"
