...
function getSectionItems(rawSection: string): string[] {
  ...
  if (key === 'skills') return [...(data.skills || []).map((item: any) => typeof item === 'string' ? item : `${item.name || item.title || 'Skill'}${item.level ? ` (${item.level}%)` : ''}`).filter(Boolean), ...extra.map((item: any) => typeof item === 'string' ? item : `${item.name || item.title || 'Skill'}${item.level ? ` (${item.level}%)` : ''}`)].filter(Boolean)
        ...
        <component :is="activeLayoutComponent" class="w-100" :style="{ background: activeTemplate?.theme?.palette?.pageBackground || '#ffffff', '--cv-primary': activeTemplate?.theme?.palette?.primary || '#1d4ed8', '--cv-secondary': activeTemplate?.theme?.palette?.secondary || '#93C5FD', '--cv-aside-width': `${asideWidth}px`, '--cv-aside-height': `${asideHeight}px`, '--cv-aside-radius': `${asideRadius}px`, '--cv-text-fullname': textFontPreset('fullName'), '--cv-text-section-label': textFontPreset('sectionLabel'), '--cv-text-entry-title': textFontPreset('entryTitle'), '--cv-text-body': textFontPreset('body') }">
          ...
          <template #content>
            <div v-if="isSideContentLayout && activeTemplate?.structure === 'structure-1'" class="cv-sections-list">
              <div class="cv-section-row" v-if="isSectionVisible('experience')"><div class="cv-section-toolbar"><AppSelect v-model="sectionTypeOverrides['experience']" :items="getSectionVariantOptions('experience')" item-title="title" item-value="value" density="compact" variant="outlined" hide-details prepend-inner-icon="mdi-shape-outline" class="cv-variant-select" /><v-btn icon="mdi-plus" size="x-small" variant="text" @click.stop="addSectionItem('experience')"/><v-btn icon="mdi-minus" size="x-small" variant="text" @click.stop="hideSection('experience')"/><v-btn icon="mdi-drag" size="x-small" variant="text" @click.stop="moveSection('contentBase', 'Experience')"/></div><strong><v-icon icon="mdi-briefcase-outline" size="16" class="mr-1" />Experience</strong><component :is="resolveSectionComponent('experience', effectiveSectionType('experience', sectionType('experience')))" :items="getSectionItems('experience')" :text="getSectionItems('experience')[0]" /></div>
              <div class="cv-section-row" v-if="isSectionVisible('education')"><div class="cv-section-toolbar"><AppSelect v-model="sectionTypeOverrides['education']" :items="getSectionVariantOptions('education')" item-title="title" item-value="value" density="compact" variant="outlined" hide-details prepend-inner-icon="mdi-shape-outline" class="cv-variant-select" /><v-btn icon="mdi-plus" size="x-small" variant="text" @click.stop="addSectionItem('education')"/><v-btn icon="mdi-minus" size="x-small" variant="text" @click.stop="hideSection('education')"/><v-btn icon="mdi-drag" size="x-small" variant="text" @click.stop="moveSection('contentBase', 'Education')"/></div><strong><v-icon icon="mdi-school-outline" size="16" class="mr-1" />Education</strong><component :is="resolveSectionComponent('education', effectiveSectionType('education', sectionType('education')))" :items="getSectionItems('education')" :text="getSectionItems('education')[0]" /></div>
              <div class="cv-section-row" v-if="isSectionVisible('projects')"><div class="cv-section-toolbar"><AppSelect v-model="sectionTypeOverrides['projects']" :items="getSectionVariantOptions('projects')" item-title="title" item-value="value" density="compact" variant="outlined" hide-details prepend-inner-icon="mdi-shape-outline" class="cv-variant-select" /><v-btn icon="mdi-plus" size="x-small" variant="text" @click.stop="addSectionItem('projects')"/><v-btn icon="mdi-minus" size="x-small" variant="text" @click.stop="hideSection('projects')"/><v-btn icon="mdi-drag" size="x-small" variant="text" @click.stop="moveSection('contentBase', 'Projects')"/></div><strong><v-icon icon="mdi-folder-outline" size="16" class="mr-1" />Projects</strong><component :is="resolveSectionComponent('projects', effectiveSectionType('projects', sectionType('projects')))" :items="getSectionItems('projects')" :text="getSectionItems('projects')[0]" /></div>
            </div>
            <div v-else-if="isSideContentLayout && activeTemplate?.structure === 'structure-2'" class="cv-sections-structure-2">
              <div class="cv-section-row" v-if="isSectionVisible('experience')"><div class="cv-section-toolbar"><AppSelect v-model="sectionTypeOverrides['experience']" :items="getSectionVariantOptions('experience')" item-title="title" item-value="value" density="compact" variant="outlined" hide-details prepend-inner-icon="mdi-shape-outline" class="cv-variant-select" /><v-btn icon="mdi-plus" size="x-small" variant="text" @click.stop="addSectionItem('experience')"/><v-btn icon="mdi-minus" size="x-small" variant="text" @click.stop="hideSection('experience')"/><v-btn icon="mdi-drag" size="x-small" variant="text" @click.stop="moveSection('contentBase', 'Experience')"/></div><strong><v-icon icon="mdi-briefcase-outline" size="16" class="mr-1" />Experience</strong><component :is="resolveSectionComponent('experience', effectiveSectionType('experience', sectionType('experience')))" :items="getSectionItems('experience')" :text="getSectionItems('experience')[0]" /></div>
              <div class="cv-section-row" v-if="isSectionVisible('education')"><div class="cv-section-toolbar"><AppSelect v-model="sectionTypeOverrides['education']" :items="getSectionVariantOptions('education')" item-title="title" item-value="value" density="compact" variant="outlined" hide-details prepend-inner-icon="mdi-shape-outline" class="cv-variant-select" /><v-btn icon="mdi-plus" size="x-small" variant="text" @click.stop="addSectionItem('education')"/><v-btn icon="mdi-minus" size="x-small" variant="text" @click.stop="hideSection('education')"/><v-btn icon="mdi-drag" size="x-small" variant="text" @click.stop="moveSection('contentBase', 'Education')"/></div><strong><v-icon icon="mdi-school-outline" size="16" class="mr-1" />Education</strong><component :is="resolveSectionComponent('education', effectiveSectionType('education', sectionType('education')))" :items="getSectionItems('education')" :text="getSectionItems('education')[0]" /></div>
              <div class="cv-section-row" v-if="isSectionVisible('projects')"><div class="cv-section-toolbar"><AppSelect v-model="sectionTypeOverrides['projects']" :items="getSectionVariantOptions('projects')" item-title="title" item-value="value" density="compact" variant="outlined" hide-details prepend-inner-icon="mdi-shape-outline" class="cv-variant-select" /><v-btn icon="mdi-plus" size="x-small" variant="text" @click.stop="addSectionItem('projects')"/><v-btn icon="mdi-minus" size="x-small" variant="text" @click.stop="hideSection('projects')"/><v-btn icon="mdi-drag" size="x-small" variant="text" @click.stop="moveSection('contentBase', 'Projects')"/></div><strong><v-icon icon="mdi-folder-outline" size="16" class="mr-1" />Projects</strong><component :is="resolveSectionComponent('projects', effectiveSectionType('projects', sectionType('projects')))" :items="getSectionItems('projects')" :text="getSectionItems('projects')[0]" /></div>
              <div class="cv-section-row" v-if="isSectionVisible('skills')"><div class="cv-section-toolbar"><AppSelect v-model="sectionTypeOverrides['skills']" :items="getSectionVariantOptions('skills')" item-title="title" item-value="value" density="compact" variant="outlined" hide-details prepend-inner-icon="mdi-shape-outline" class="cv-variant-select" /><v-btn icon="mdi-plus" size="x-small" variant="text" @click.stop="addSectionItem('skills')"/><v-btn icon="mdi-minus" size="x-small" variant="text" @click.stop="hideSection('skills')"/><v-btn icon="mdi-drag" size="x-small" variant="text" @click.stop/></div><strong><v-icon icon="mdi-star-outline" size="16" class="mr-1" />Skills</strong><component :is="resolveSectionComponent('skills', effectiveSectionType('skills', sectionType('skills')))" :items="getSectionItems('skills')" :text="getSectionItems('skills')[0]" /></div>
            </div>
            <div v-else-if="isMainStructureLayout && activeTemplate?.structure === 'structure-1'" class="cv-sections-list">
              <div v-for="section in orderedSections('mainOne', structureOneSections)" :key="`s1-${section}`" class="cv-section-row" v-if="isSectionVisible(toSectionKey(section))"><div class="cv-section-toolbar"><AppSelect v-model="sectionTypeOverrides[toSectionKey(section)]" :items="getSectionVariantOptions(toSectionKey(section))" item-title="title" item-value="value" density="compact" variant="outlined" hide-details prepend-inner-icon="mdi-shape-outline" class="cv-variant-select" /><v-btn icon="mdi-plus" size="x-small" variant="text" @click.stop="addSectionItem(toSectionKey(section))"/><v-btn icon="mdi-minus" size="x-small" variant="text" @click.stop="hideSection(toSectionKey(section))"/><v-btn icon="mdi-drag" size="x-small" variant="text" @click.stop="moveSection('mainOne', section)"/></div><strong><v-icon :icon="sectionIconMap[toSectionKey(section)] || 'mdi-circle-small'" size="16" class="mr-1" />{{ section }}</strong><component :is="resolveSectionComponent(toSectionKey(section), effectiveSectionType(toSectionKey(section), sectionType(toSectionKey(section) as any)))" :items="getSectionItems(section)" :text="getSectionItems(section)[0]" /></div>
            </div>
            <div v-else-if="isMainStructureLayout && activeTemplate?.structure === 'structure-2'" class="cv-sections-structure-2">
              <div v-for="section in orderedSections('mainTwoTop', structureTwoTopSections)" :key="`s2-top-${section}`" class="cv-section-row" v-if="isSectionVisible(toSectionKey(section))"><div class="cv-section-toolbar"><AppSelect v-model="sectionTypeOverrides[toSectionKey(section)]" :items="getSectionVariantOptions(toSectionKey(section))" item-title="title" item-value="value" density="compact" variant="outlined" hide-details prepend-inner-icon="mdi-shape-outline" class="cv-variant-select" /><v-btn icon="mdi-plus" size="x-small" variant="text" @click.stop="addSectionItem(toSectionKey(section))"/><v-btn icon="mdi-minus" size="x-small" variant="text" @click.stop="hideSection(toSectionKey(section))"/><v-btn icon="mdi-drag" size="x-small" variant="text" @click.stop="moveSection('mainTwoTop', section)"/></div><strong><v-icon :icon="sectionIconMap[toSectionKey(section)] || 'mdi-circle-small'" size="16" class="mr-1" />{{ section }}</strong><component :is="resolveSectionComponent(toSectionKey(section), effectiveSectionType(toSectionKey(section), sectionType(toSectionKey(section) as any)))" :items="getSectionItems(section)" :text="getSectionItems(section)[0]" /></div>
              <v-row class="mt-1" dense>
                <v-col cols="6">
                  <div v-for="section in orderedSections('mainTwoLeft', structureTwoLeftSections)" :key="`s2-left-${section}`" class="cv-section-row" v-if="isSectionVisible(toSectionKey(section))"><div class="cv-section-toolbar"><AppSelect v-model="sectionTypeOverrides[toSectionKey(section)]" :items="getSectionVariantOptions(toSectionKey(section))" item-title="title" item-value="value" density="compact" variant="outlined" hide-details prepend-inner-icon="mdi-shape-outline" class="cv-variant-select" /><v-btn icon="mdi-plus" size="x-small" variant="text" @click.stop="addSectionItem(toSectionKey(section))"/><v-btn icon="mdi-minus" size="x-small" variant="text" @click.stop="hideSection(toSectionKey(section))"/><v-btn icon="mdi-drag" size="x-small" variant="text" @click.stop="moveSection('mainTwoLeft', section)"/></div><strong><v-icon :icon="sectionIconMap[toSectionKey(section)] || 'mdi-circle-small'" size="16" class="mr-1" />{{ section }}</strong><component :is="resolveSectionComponent(toSectionKey(section), effectiveSectionType(toSectionKey(section), sectionType(toSectionKey(section) as any)))" :items="getSectionItems(section)" :text="getSectionItems(section)[0]" /></div>
                </v-col>
                <v-col cols="6">
                  <div v-for="section in orderedSections('mainTwoRight', structureTwoRightSections)" :key="`s2-right-${section}`" class="cv-section-row" v-if="isSectionVisible(toSectionKey(section))"><div class="cv-section-toolbar"><AppSelect v-model="sectionTypeOverrides[toSectionKey(section)]" :items="getSectionVariantOptions(toSectionKey(section))" item-title="title" item-value="value" density="compact" variant="outlined" hide-details prepend-inner-icon="mdi-shape-outline" class="cv-variant-select" /><v-btn icon="mdi-plus" size="x-small" variant="text" @click.stop="addSectionItem(toSectionKey(section))"/><v-btn icon="mdi-minus" size="x-small" variant="text" @click.stop="hideSection(toSectionKey(section))"/><v-btn icon="mdi-drag" size="x-small" variant="text" @click.stop="moveSection('mainTwoRight', section)"/></div><strong><v-icon :icon="sectionIconMap[toSectionKey(section)] || 'mdi-circle-small'" size="16" class="mr-1" />{{ section }}</strong><component :is="resolveSectionComponent(toSectionKey(section), effectiveSectionType(toSectionKey(section), sectionType(toSectionKey(section) as any)))" :items="getSectionItems(section)" :text="getSectionItems(section)[0]" /></div>
                </v-col>
              </v-row>
            </div>
