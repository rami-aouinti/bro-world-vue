...
export const RESUME_BASE_PRESETS: ResumeBasePreset[] = [
  {
    ...
    name: 'Mono Classic Flow',
    thumbnail: '/img/cv/resume-modern.svg',
    tags: ['mono', 'classic'],
    version: '1.0.0',
  },
  {
  ...
  {
    id: 'base-aside-left-a',
    layoutId: 'layout-aside-left-a',
    structureId: 'aside-left',
    name: 'Left Sidebar Standard',
    thumbnail: '/img/cv/resume-modern.svg',
    tags: ['left-sidebar'],
    version: '1.0.0',
  },
  {
    id: 'base-aside-left-b',
    layoutId: 'layout-aside-left-b',
    structureId: 'aside-left',
    name: 'Left Sidebar Skills',
    thumbnail: '/img/cv/resume-modern.svg',
    tags: ['left-sidebar', 'skills'],
    version: '1.0.0',
  },
  {
    id: 'base-aside-left-c',
    layoutId: 'layout-aside-left-c',
    structureId: 'aside-left',
    name: 'Left Sidebar Hybrid',
    thumbnail: '/img/cv/resume-modern.svg',
    tags: ['left-sidebar', 'hybrid'],
    version: '1.0.0',
  },
  {
    id: 'base-aside-right-a',
    layoutId: 'layout-aside-right-a',
    structureId: 'aside-right',
    name: 'Right Sidebar Standard',
    thumbnail: '/img/cv/resume-modern.svg',
    tags: ['right-sidebar'],
    version: '1.0.0',
  },
  {
    id: 'base-aside-right-b',
    layoutId: 'layout-aside-right-b',
    structureId: 'aside-right',
    name: 'Right Sidebar Skills',
    thumbnail: '/img/cv/resume-modern.svg',
    tags: ['right-sidebar', 'skills'],
    version: '1.0.0',
  },
  {
    id: 'base-aside-right-c',
    layoutId: 'layout-aside-right-c',
    structureId: 'aside-right',
    name: 'Right Sidebar Hybrid',
    thumbnail: '/img/cv/resume-modern.svg',
    tags: ['right-sidebar', 'hybrid'],
    version: '1.0.0',
  },
  {
    id: 'base-hero-header',
    layoutId: 'layout-hero-header-content-split',
    structureId: 'no-aside',
    name: 'Hero Header Split',
    thumbnail: '/img/cv/resume-midnight-banner.svg',
    tags: ['hero', 'banner'],
    version: '1.0.0',
  },
]
...
export const RESUME_COMPOSED_PRESET_METADATA: ResumeComposedPresetMeta[] =
  RESUME_BASE_PRESETS.flatMap((base) =>
    RESUME_STYLE_PACKS.filter(
      (style) => !INCOHERENT_COMBINATIONS.has(`${base.id}::${style.id}`),
    ).map((style) => ({
...
if (RESUME_COMPOSED_PRESET_METADATA.length !== 90) {
  throw new Error(
    `Expected 90 composed resume presets, received ${RESUME_COMPOSED_PRESET_METADATA.length}`,
  )
}

export function buildResumeTemplateFromPreset(
  meta: ResumeComposedPresetMeta,
): Pick<ResumeTemplateConfig, 'id' | 'label' | 'subtitle' | 'image'> {
  return {
    id: meta.id,
    label: meta.name,
