...
export const RESUME_TEMPLATES_CATALOG: ResumeTemplateConfig[] = [
  {
    id: 'executive-portrait', label: 'Executive Portrait', subtitle: 'Large hero name with rounded portrait focus', type: 'resume', image: '/img/cv/resume-executive-portrait.svg', variant: 'corporate-blue', layoutMode: 'split', sections: DEFAULT_RESUME_SECTIONS, styleVars: { palette: 'corporate-blue', radius: 'soft', typography: 'executive', sectionVariant: 'detailed', iconStyle: 'filled' }, visibleOptions: { photo: true, twoColumn: true, ats: true, docx: true, customized: true, free: true, timeline: false },
  },
  { id: 'midnight-banner', label: 'Midnight Banner', subtitle: 'Dark header band with profile image and split details', type: 'resume', image: '/img/cv/resume-midnight-banner.svg', variant: 'executive', layoutMode: 'split', sections: DEFAULT_RESUME_SECTIONS, styleVars: { palette: 'midnight', radius: 'soft', typography: 'modern', sectionVariant: 'timeline', iconStyle: 'outline' }, visibleOptions: { photo: true, twoColumn: true, ats: false, docx: true, customized: true, free: true, timeline: true } },
  { id: 'minimal-profile', label: 'Minimal Profile', subtitle: 'Clean profile block with light sidebar and compact details', type: 'resume', image: '/img/cv/resume-minimal-profile.svg', variant: 'minimalist', layoutMode: 'split', sections: DEFAULT_RESUME_SECTIONS, styleVars: { palette: 'minimal', radius: 'none', typography: 'clean', sectionVariant: 'compact', iconStyle: 'text' }, visibleOptions: { photo: true, twoColumn: true, ats: true, docx: true, customized: true, free: true, timeline: false } },
  { id: 'classic', label: 'Classic', subtitle: 'Simple and readable format', type: 'resume', image: '/img/cv/resume-classic.svg', variant: 'classic', layoutMode: 'stacked', sections: DEFAULT_RESUME_SECTIONS, styleVars: { palette: 'classic', radius: 'none', typography: 'serif', sectionVariant: 'classic', iconStyle: 'text' }, visibleOptions: { photo: false, twoColumn: false, ats: false, docx: true, customized: false, free: true, timeline: false } },
  { id: 'modern', label: 'Modern', subtitle: 'Clean blocks and balanced content', type: 'resume', image: '/img/cv/resume-modern.svg', variant: 'modern', layoutMode: 'split', sections: DEFAULT_RESUME_SECTIONS, styleVars: { palette: 'modern', radius: 'soft', typography: 'sans', sectionVariant: 'list', iconStyle: 'filled' }, visibleOptions: { photo: true, twoColumn: true, ats: false, docx: true, customized: true, free: true, timeline: false } },
