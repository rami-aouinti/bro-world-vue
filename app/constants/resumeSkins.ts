import type {
  ResumeTemplateIconStyle,
  ResumeTemplateSkinId,
...
export const RESUME_SKINS_REGISTRY: Record<
  ResumeTemplateSkinId,
  ResumeSkinTokens
> = {
...
export const RESUME_SKIN_IDS = Object.keys(
  RESUME_SKINS_REGISTRY,
) as ResumeTemplateSkinId[]
