...
export const RESUME_TEMPLATES = RESUME_TEMPLATES_CATALOG.filter((t) => t.type === 'resume').map((t) => ({
  id: t.id,
  title: t.label,
  subtitle: t.subtitle,
  image: t.image,
...
export const COVER_PAGE_TEMPLATES = RESUME_TEMPLATES_CATALOG.filter((t) => t.type === 'cover-page').map((t) => ({
  id: t.id,
  title: t.label,
  subtitle: t.subtitle,
  image: t.image,
...
export const COVER_LETTER_TEMPLATES = RESUME_TEMPLATES_CATALOG.filter((t) => t.type === 'cover-letter').map((t) => ({
  id: t.id,
  title: t.label,
  subtitle: t.subtitle,
  image: t.image,
