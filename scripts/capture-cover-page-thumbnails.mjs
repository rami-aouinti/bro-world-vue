...
const templatesPath = path.join(root, 'app/data/resume-templates/generated-20-cover-page.json')
...
await browser.close()
console.log(`✅ Captured ${generatedCoverPageTemplates.length} templates in ${outDir}`)
