...
const templatesPath = path.join(root, 'app/data/resume-templates/generated-20-cover-letter.json')
...
await browser.close()
console.log(`✅ Captured ${generatedCoverLetterTemplates.length} templates in ${outDir}`)
